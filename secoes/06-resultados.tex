...
/*
	Prompt: 
Explique o operador spread (...), o que faz neste codigo e qual sera o conteudo final das variaveis merged.
*/
const arr1 = [1, 2, 3];
const arr2 = [4, 5, 6];
